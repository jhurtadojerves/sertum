...
from .views import CreateServiceView, ListServiceView, ListServiceViewFilter, EditServiceView
...
urlpatterns = [
    ...
    url(r'^servicios/editar/(?P<pk>\d+)/$', EditServiceView.as_view(), name='center_service_edit'),
]
